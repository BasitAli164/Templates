...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function addTask() {
        ...
        if (text) {
            ...
            addTaskBtn.innerHTML = '<i class="fas fa-check"></i>';
    ...
    function createTaskElement(task) {
        ...
        <div class="flex items-start">
            <label class="flex items-start cursor-pointer">
                ...
                >
                <div class="ml-3">
                    <span class="task-text block text-lg ${task.completed
                ...
                : "text-gray-700"
                    ...
                    <div class="flex flex-wrap gap-2 mt-2">
                        <span class="inline-block px-2 py-1 rounded-full text-xs font-medium ${getCategoryClass(
                task.category
            )}">
    ...
    function editTask(e) {
        ...
        if (task) {
            ...
            editForm.className = "flex flex-col gap-3 w-full";
            ...
            editForm.innerHTML = `
                    ...
                    <div class="flex flex-wrap gap-3">
                        <select id="edit-category" class="flex-1 px-4 py-2 rounded-lg border focus:outline-none">
                            <option value="general" ${task.category === "general" ? "selected" : ""
                }>General</option>
                            ...
                            <option value="health" ${task.category === "health" ? "selected" : ""
                }>Health</option>
                        </select>
            ...
            const handleEdit = () => {
                ...
                const newPriority =
                    editForm.querySelector("#edit-priority").value;
    ...
    function updateStats() {
        ...
        remainingTasks.textContent = `${activeTasks} ${activeTasks === 1 ? "task" : "tasks"
            } left`;

        taskCount.classList.add("animate-pulse");
        setTimeout(() => {
            taskCount.classList.remove("animate-pulse");
        }, 300);
    }
